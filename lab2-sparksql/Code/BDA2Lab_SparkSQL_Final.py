...
tempavg = filtered.groupBy('year','month', 'stationNum').agg((F.sum('airTemp')/F.count('airTemp')).alias('avgMonthlyTemperature'))            .orderBy("stationNum","year","month",ascending=False)
